const int N_Greenled=1;
const int N_Yellowled=2;
const int N_Redled=3;
const int S_Greenled=4;
const int S_Yellowled=5;
const int S_Redled=6;
const int E_Greenled=7;
const int E_Yellowled=8;
const int E_Redled=9;
const int W_Greenled=10;
const int W_Yellowled=11;
const int W_Redled=12;
...
void loop() {
  ...
  digitalWrite(S_Yellowled,LOW);
  digitalWrite(N_Redled,HIGH);
  digitalWrite(S_Redled,HIGH);
  //delay(2000);
  digitalWrite(E_Redled,LOW);
  digitalWrite(W_Redled,LOW);
  delay(2000);
